...
from models.transaction_model import AirtimeTransaction

def generate_request_id():
    return str(uuid.uuid4())

def buy_airtime_service(phone_number, amount, network):
    ...
    payload = {
        ...
        "serviceID": "mtn",  # e.g., mtn, glo, airtel, etisalat
        "phone_number": "08101111111",  # replace with actual phone number
        
        "amount": "100",
        "request_id": "202508020432uegrhhhdbhh",  # Unique request ID
    }
